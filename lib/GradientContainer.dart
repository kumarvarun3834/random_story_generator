...
import 'package:random_story_generator/cardContainer.dart';

// dataset its generated by Chatgpt with given specific format
    ...
    return Column(
        ...
        children: [
          if (global.charPart != "NaN")
            CardContainer("Story: ${global.charPart} ${global.settPart} ${global.actionPart}"),
          if (global.moralPart != "NaN")
          TextContainer('Moral:${global.moralPart}'),
